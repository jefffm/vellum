...
<mei xmlns="http://www.music-encoding.org/ns/mei" meiversion="5.1">
  <meiHead><fileDesc><titleStmt><title>Vellum French tablature proof</title></titleStmt><pubStmt><p>Project-authored development fixture</p></pubStmt></fileDesc></meiHead>
  <music><body><mdiv><score>
    ...
    <section><measure n="1" xml:id="measure-1"><staff n="1"><layer n="1">
      <tabGrp dur="4" dots="1" xml:id="event-1"><tabDurSym xml:id="rhythm-1"/><note tab.course="1" tab.fret="1" xml:id="note-1"/><note tab.course="3" tab.fret="0" xml:id="note-2"/><note tab.course="5" tab.fret="2" xml:id="note-3"/></tabGrp>
      <tabGrp dur="8" xml:id="event-2"><tabDurSym xml:id="rhythm-2"/><note tab.course="1" tab.fret="3" xml:id="note-4"/></tabGrp>
      <tabGrp dur="4" xml:id="event-3"><tabDurSym xml:id="rhythm-3"/><note tab.course="2" tab.fret="1" xml:id="note-5"/><note tab.course="4" tab.fret="2" xml:id="note-6"/></tabGrp>
...
<mei xmlns="http://www.music-encoding.org/ns/mei" meiversion="5.1">
  <meiHead><fileDesc><titleStmt><title>Vellum diapason proof</title></titleStmt><pubStmt><p>Project-authored development fixture</p></pubStmt></fileDesc></meiHead>
  <music><body><mdiv><score>
