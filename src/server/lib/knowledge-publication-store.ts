...
export const KnowledgePublicationRecordKindSchema = Type.Union([
  ...
  Type.Literal("reviewer_authority_scope"),
  Type.Literal("reviewer_identity_snapshot"),
  Type.Literal("reviewer_credential_assertion"),
  Type.Literal("reviewer_trust_policy"),
  Type.Literal("reviewer_revocation_snapshot"),
  Type.Literal("reviewer_verifier_receipt"),
  Type.Literal("release_attestation"),
  Type.Literal("release_advisory"),
  Type.Literal("attestation_verification"),
  Type.Literal("advisory_verification"),
  ...
  Type.Literal("knowledge_resolution_context"),
  Type.Literal("knowledge_resolution_policy"),
  Type.Literal("knowledge_inventory_outcome"),
  Type.Literal("knowledge_predicate_result"),
