...
Requirement families touched: II-CG-001–002, II-CG-004–005, II-EXEC-010B, II-MC-024–025
...
- [ ] Search state links left-hand contacts/transitions/barré/holds with the exact profile's right-hand resource set, allocation, preparation, alternation, crossing, simultaneity, release, and phrase boundaries; `p-i-m-a` is one profile-scoped classical-guitar resource vocabulary, not a shared universal.
